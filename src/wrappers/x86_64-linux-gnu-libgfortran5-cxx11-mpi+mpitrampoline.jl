# Autogenerated wrapper script for libminc_jll for x86_64-linux-gnu-libgfortran5-cxx11-mpi+mpitrampoline
...
function __init__()
    JLLWrappers.@generate_init_header(HDF5_jll, NetCDF_jll, MPIPreferences, CompilerSupportLibraries_jll)
